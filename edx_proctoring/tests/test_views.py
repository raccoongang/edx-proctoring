...
from .utils import (
    ...
    MockedCourse, MockedModulestore, MockedCourseKey)
...
@patch.dict('django.conf.settings.PROCTORING_BACKEND_PROVIDERS',
            {"a": {}, "b": {}, "c": {}})
class TestProctoringServicesView(LoggedInTestCase):
    ...
    def test_get_services(self):
        """
        Test getting list of proctoring services which available for current
        Course
        """
